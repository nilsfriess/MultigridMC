...
if(CHOLMOD_LIBRARY)
    ...
    if (${CHOLMOD_INCLUDE_DIR} MATCHES "CHOLMOD_INCLUDE_DIR-NOTFOUND")
        cmake_path(APPEND CHOLMOD_DIR "..")
        cmake_path(NORMAL_PATH CHOLMOD_DIR)
        find_path(CHOLMOD_INCLUDE_DIR NAMES cholmod.h PATHS ${CHOLMOD_DIR} PATH_SUFFIXES suitesparse include)
    endif()
