...
protected:
    ...
    /** @brief 2*pi */
    const double two_pi;
    /** @brief flag which indicates whether we need to draw new random numbers for Box-Muller */
    bool box_muller_redraw;
    /** @brief first normal random number generated by Box-Muller */
    double z_1;
    /** @brief second normal random number generated by Box-Muller */
    double z_2;
};
